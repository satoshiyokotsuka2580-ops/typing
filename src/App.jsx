...
export default function App(){
 ...
 function start(){if(!pool.length)return;setJoinRanking(false);setResultSaved(false);setQueue(shuffle(pool));setIdx(0);typedRef.current="";setTyped("");setTime(duration);setElapsedSeconds(0);setCorrect(0);setKeys(0);setMistakes(0);streakRef.current=0;setStreak(0);setCompleted(0);setScreen("playing")}
 ...
 return <main><div className="glow a"/><div className="glow b"/><div className="shell"><header><button className="brand" onClick={()=>setScreen("home")}><i><Keyboard/></i><span><b>TYPE//LAB</b><small>Typing Studio v11</small></span></button><div className="status"><i/>Cloudflare Ready</div></header>
